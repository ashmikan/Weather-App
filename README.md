...
Live, interactive weather UI built with React + Vite.
...
SkyLumin is a small weather application that queries OpenWeatherMap to show current conditions with animated backgrounds and helpful weather metrics.
...
**License**
This repository currently has no license file. Add one if you plan to open-source the project.
